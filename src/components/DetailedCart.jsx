...
import { REMOVE_FROM_CART, ADD_TO_CART, QUANTITY_DECREMENT, CLEAR_CART } from '../redux/actions/action'
import { ShoppingCartCheckoutOutlined, DangerousOutlined} from '@mui/icons-material'
            ...
            <div className='cartContainer d-flex justify-content-around'>
                                    ...
                                    <div className="details">
                                        <Table>
                                            <tr>
                                                ...
                                                <span style={{background: 'green', color: '#fff', padding: '3px 5px', borderRadius: '5px'}}> {e.rating} ★ </span>  </p>
                                                <p> <strong> Brand : </strong> {e.brand} </p>
                                                <p> <strong> Item Total : </strong> ₹ {e.price*e.stock} </p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div className='d-flex justify-content-between align-items-center' style={{width: 100, cursor: 'pointer', background: '#ddd', color: '#111'}}>
                                                        {
                                                            e.stock>1 ? <span style={{fontSize: 24}} onClick={()=> quantityDec(e)}>
                                                            -
                                                            </span> :
                                                        ...
                                                        <span style={{fontSize: 24}} onClick={()=> addToCart(e)}>
                                                            +
                                                        </span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p style={{cursor: 'pointer'}} onClick={()=> removeFromCart(e.id)}> <DeleteRounded color='error'/> Remove </p>
                                                </td>
                                            </tr>
                                        </Table>
                                    </div>
                ...
                <div className='checkout-container'>
                    <Card style={{ width: '18rem' }}>
                        <Card.Img variant="top" src='https://cdn-icons-png.flaticon.com/512/536/536473.png' />
                        <Card.Body>
                            ...
                            <div className='d-flex justify-content-around'>
                                <Button variant="danger" onClick={()=>clearCart()}> <DangerousOutlined/> Clear Cart </Button>
                                <Button variant="success"> <ShoppingCartCheckoutOutlined /> Checkout </Button>
                            </div>
                        </Card.Body>
                    </Card>
                </div>
