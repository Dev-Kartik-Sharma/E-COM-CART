        ...
        <>
            <div className='container mt-3'>
                ...
                <div className='row d-flex justify-content-center align-items-center'>
                    {
                        (loading) ? <Box sx={{height: 300}} className='d-flex justify-content-center align-items-center'> 
                                        <CircularProgress />
                                    </Box>
                        :
                        data.map((element, id) => {
                            ...
                            <> 
                                <Card className="mx-2 mt-4 card_style" style={{ width: '22rem', border: 'none' }}>
                                    <Card.Img variant="top" src={element.thumbnail} style={{height: '16rem', marginTop: '12px'}}/>
                                    <Card.Body>
                                        ...
                                        <div className="button_div d-flex justify-content-center">
                                            ...
                                            onClick={()=> sendToReducer(element)}> Add to cart 
                                            </Button>
                                        </div>
                                    </Card.Body>
                                </Card>   
